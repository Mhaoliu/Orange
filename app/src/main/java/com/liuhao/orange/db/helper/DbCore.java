...
import com.liuhao.orange.db.dao.DaoSession;
 ...
 */
public class DbCore {
    private static final String DEFAULT_DB_NAME = "orange.db";
    ...
    public static DaoMaster getDaoMaster() {
        if (daoMaster == null) {
            ...
            DaoMaster.OpenHelper helper = new DaoOpenHelper(mContext, DB_NAME);
